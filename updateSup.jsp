...
<div class="d-flex">
    ...
    <main class="content">
        ...
        <%
            ...
            List<SupplierM> al = p.checkid(id);
            for (SupplierM e : al) {
        %>
            ...
            <form action="update" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="supplierName" value="<%=e.getSupplierName()%>" id="itemName" placeholder="E.g.Cipla Ltd."
                               required />
                    </div>
                    <div class="col-md-6">
                        <label for="category" class="form-label">Category</label>
                        <select class="form-select" name="category"  value="<%=e.getCategory()%>"  id="category" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" name="price" value="<%=e.getPrice()%>" id="price" placeholder="E.g. 120" required />
                    </div>
                    <div class="col-md-4">
                        <label for="status" class="form-label">Availability</label>
                        <select class="form-select" name="availability" value="<%=e.getAvailability()%>" id="status" required>
                            <option selected disabled>Choose...</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="file" class="form-control" value="<%=e.getImage()%>" name="image" id="image" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="tel" class="form-control" value="<%=e.getContactNo()%>" name="contactNo" id="contactNumber"
                                   placeholder="E.g. +91 9876543210" required />
                        </div>
                        <div class="col-md-6">
                            <label for="address" class="form-label">Address</label>
                            <input type="text" class="form-control" value="<%=e.getAddress()%>" name="address" id="address"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="medicineDescription" value="<%=e.getMedicineDescription()%>" id="desc" rows="3"
